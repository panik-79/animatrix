...
export function HeroSection({
  ...
  return (
    <div id="section-hero" className="relative w-full min-h-[calc(100vh-5rem)] flex items-center justify-center border-b border-border py-12 md:py-16 overflow-hidden snap-start snap-always">
