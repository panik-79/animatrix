      ...
      <div className="flex items-center justify-between h-16 px-4 md:px-6">
        ...
        <div className="flex-1 flex justify-center md:justify-start max-w-xl mx-auto md:ml-4">
          <button
            ...
            className="flex items-center w-full max-w-sm px-4 py-2 space-x-2 text-sm rounded-full bg-secondary/50 text-muted-foreground hover:bg-secondary hover:text-foreground transition-colors border border-white/5"
          >
            <Search className="w-4 h-4" />
            <span>Search anime...</span>
            <kbd className="hidden sm:inline-block px-2 py-0.5 ml-auto text-xs font-mono rounded bg-background border border-border">
              ⌘K
            </kbd>
          </button>
        </div>
