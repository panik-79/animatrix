...
export function HomeHero() {
  ...
  return (
    <div
      className="relative h-[400px] md:h-[460px] lg:h-[500px] overflow-hidden rounded-2xl md:rounded-3xl mx-3 md:mx-6 mt-3 group isolate shadow-2xl bg-slate-950 border border-black/10"
